...
## Arrival Delay and Distance
  One might think that longer flights are expected to have longer delays. This turns out not to be true. Arrival delays and flight distance are very weakly correlated, with a spearman correlation coefficient (able to detect non-linear trends) of only -0.022. A scatter plot between these two variables suggests that these variables are relatively unrelated as well. 
...
```
  ...
  Alternatively,  box plots of flight distance grouped by every 1000 miles be examined; the distribution of arrival delays is nearly identical in all cases. Outliers have been removed because they obscure most of the distributions since there are some very clear outliers. Note that the third quantile is near zero for every box plot, meaning that 75% of the flights actually arrive on time or early. 
