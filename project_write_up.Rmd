...
Caitlyn's Work:
Caitlyn has good visualizations. There are many meaningful comparisons between variables, such as mean delay vs time, and mean delay vs airline carrier. The graphs give meaningful insight into these comparisons and show what we are trying to prove well.
