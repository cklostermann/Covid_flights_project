...
From our six visualizations, readers can observe the airline carriers’ performance during the COVID-19 pandemic. In addition, they can view the best and worst ten airports to fly from and select the best performing airline carrier. From time series analysis, the trend of the number of flights during the pandemic is shown along with the mean COVID cases per day. Readers can retrieve the relationship between cases per day and the number of flights. 
